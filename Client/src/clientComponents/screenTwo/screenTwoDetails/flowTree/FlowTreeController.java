...
public class FlowTreeController {
    ...
    private void fetchData() {
            ...
            clientComponents.screenTwo.screenTwoDetails.flowTree.UIAdapter uiAdapter = createUIAdapter();
            logic.fetchData(
                    UUID.fromString(bodyController.getFlowExecutionScreenComponentController().getExecutedFlowID().getValue()),
                    uiAdapter, isTaskFinished, bodyController.getFlowExecutionScreenComponentController().getExecutedFlowID());


        this.flowTreeView.getRoot().setExpanded(true);
    }

    private clientComponents.screenTwo.screenTwoDetails.flowTree.UIAdapter createUIAdapter() {
