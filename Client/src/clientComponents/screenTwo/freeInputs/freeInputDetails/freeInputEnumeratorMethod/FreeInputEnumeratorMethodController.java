package clientComponents.screenTwo.freeInputs.freeInputDetails.freeInputEnumeratorMethod;
...
public class FreeInputEnumeratorMethodController implements CollectionInputs {
    ...
    public FreeInputEnumeratorMethodController() {
    ...
    public void initialize() {
        ...
        freeInputEnumerator.setValue("GET"); // Set the default filter option
