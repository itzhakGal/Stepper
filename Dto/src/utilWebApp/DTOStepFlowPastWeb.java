...
public class DTOStepFlowPastWeb
{
    ...
    private List<DTOOutputDetailsWeb> dtoOutputDetails;

    private List<DTOInputDetailsWeb> dtoInputsDetails;


    public DTOStepFlowPastWeb(StepExecutionDataImpl step) {
    ...
    private void initialLists(StepExecutionDataImpl step) {
        ...
        {
            dtoOutputDetails.add(new DTOOutputDetailsWeb(data));
        }

        for (DataInFlowExecution data :step.getInputsData())
        {
            dtoInputsDetails.add(new DTOInputDetailsWeb(data));
        }
    }
    ...
    public List<DTOOutputDetailsWeb> getDtoOutputDetails() {
        return dtoOutputDetails;
    }

    public List<DTOInputDetailsWeb> getDtoInputsDetails() {
